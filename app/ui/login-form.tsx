    ...
    return (
            <div className="flex flex-col md-w:1/3 max-[352px]">
                ...
                <form action="#" className="w-full">
                    ...
                    <input type="email" name="name" className="w-full rounded-md text-monokaiYellow bg-transparent border-[1px] px-inputX py-inputY border-1 border-monokaiBlue placeholder:text-monokaiOrange mt-inputLabel mb-formInput text-input"></input>
                    <label className="text-monokaiPink text-informational">&lt;Password&gt;</label><br></br>
                    <input type="password" name="name" className="w-full rounded-md text-monokaiYellow bg-transparent border-[1px] px-inputX py-inputY border-1 border-monokaiBlue placeholder:text-monokaiOrange mt-inputLabel mb-informational text-input"></input>
