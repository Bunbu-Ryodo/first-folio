    ...
    return (
            <div className="flex flex-col md:w-1/3 max-[352px]">
                ...
                <form onSubmit={handleSubmit} className="w-full">
                    ...
                    <input type="password" name="password" className="opacity-0 animate-fade-in w-full rounded-md text-monokaiYellow bg-transparent border-[1px] px-inputX py-inputY border-1 border-monokaiBlue placeholder:text-monokaiOrange mt-inputLabel mb-informational text-input"></input>
                    ...
                    {errorMessage &&
                        <div key={errorMessage} className="opacity-0 animate-fade-in mt-2 mb-2 text-informational text-monokaiPurple">
                            {errorMessage}
                        </div>
                    }
                </form>
