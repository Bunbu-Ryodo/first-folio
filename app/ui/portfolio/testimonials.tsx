...
export default function Testimonials({
  ...
  return (
    <div id="testimonials" className="bg-portfolioNeutral p-8 h-auto">
      <div className="flex flex-col w-full items-center lg:flex-row lg:justify-between h-full">
        <div className="flex flex-col w-full lg:w-1/4 justify-center items-center bg-portfolioPrimary text-portfolioSecondary p-8 my-8 rounded min-h-[352px] shadow-xl">
