    ...
    <div id="testimonials">
      <div className="flex flex-col w-full px-8 py-8">
        <div className="flex flex-row justify-center items-center">
          <h1 className={`opacity-0 text-display mb-title ${getFadeClass(0)}`}>
            Testimonials
          </h1>
        </div>
        ...
        <div className="flex flex-col md:flex-row w-full">
          <div className="flex flex-col w-full md:w-1/2 items-center justify-center px-8 md:py-8">
            ...
            >
              {endorsements[1].comments ? `"${endorsements[1].comments}"` : ""}
            </span>
            <span
              className={`opacity-0 ${
                robotoMono.className
          ...
          <div className="flex flex-col w-full md:w-1/2 items-center justify-center p-8">
            ...
            >
              {endorsements[2].comments ? `"${endorsements[2].comments}"` : ""}
            </span>
            <span
              className={`opacity-0 ${
                robotoMono.className
